            ...
            <View key={outfit.id || index} style={styles.outfitBlock}>
              ...
              <View style={styles.card}>
                ...
                <View style={styles.photosContent}>
                  ...
                  <TouchableOpacity style={styles.addPhotoBtn} onPress={() => handleUploadReferencePhoto(outfit.id)} disabled={loading}>
                    {isUploading ? <ActivityIndicator size="small" color={Colors.primary} /> : <Plus size={20} color={Colors.primary} />}
                  </TouchableOpacity>
                </View>
              </View>
              ...
              <View style={styles.pricingCard}>
                <Text style={styles.pricingTitle}>{outfitName}</Text>
                <View style={styles.pricingRow}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Scissors size={14} color="#94A3B8" style={{marginRight: 8}} />
                    <Text style={styles.pricingItemText}>Stitching</Text>
                  </View>
                  <Text style={styles.pricingItemValue}>₹{order.total || 1800}</Text>
                </View>
                <View style={styles.pricingRow}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <FileText size={14} color="#94A3B8" style={{marginRight: 8}} />
                    <Text style={styles.pricingItemText}>Falls</Text>
                  </View>
                ...
                <View style={styles.pricingRow}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <FileText size={14} color="#94A3B8" style={{marginRight: 8}} />
                    <Text style={styles.pricingItemText}>Lining</Text>
                  </View>
                  <Text style={styles.pricingItemValue}>₹0</Text>
                </View>
                ...
                <View style={styles.pricingTotalRow}>
                  <Text style={styles.pricingTotalLabel}>TOTAL BILLING</Text>
                  <Text style={styles.pricingTotalValue}>₹{order.total || 0}</Text>
                </View>
...
fs.writeFileSync('/Users/bhuvan/Documents/Bhuvan/Products/Sewvee-Customer-Mobile/src/screens/CustomerOrderDetailScreen.js', code);
