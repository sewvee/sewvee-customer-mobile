...
const newHeader = `        <View style={[styles.navbar, { justifyContent: 'space-between', paddingHorizontal: 16, paddingTop: 16, paddingBottom: 16, height: 'auto' }]}>
          <TouchableOpacity 
...
const endIdx = code.indexOf('      </SafeAreaView>', startIdx);
